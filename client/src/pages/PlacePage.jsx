...
export default function PlacesPage() {
    ...
    <div>
      {action !== "new" && (
        <div className="text-center mt-4">
          <Link
            className="inline-flex gap-1 bg-primary text-white py-2 px-6 rounded-full inline-flex items-center gap-2"
      ...
      {action === "new" && (
        <form>
          ...
          <div className="flex">
            ...
            <button className="bg-gray-200 px-4 rounded-2xl">Addnsbt; photo</button>
          </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M12 9l-3 3m0 0 3 3m-3-3h12.75" />
          ...
          <p className="text-gray-500 text-sm">Add check in and out times , remember to have some time window for cleaning room between guests</p>
